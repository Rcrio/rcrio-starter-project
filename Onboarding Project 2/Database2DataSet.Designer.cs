...
namespace Onboarding_Project_2 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class userInfoDataTable : global::System.Data.TypedTableBase<userInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userInfoRow AdduserInfoRow(int id, string userEmail, string userPassword, string userFirstName, string userLastName, int userPhoneNo) {
            ...
            private void InitClass() {
                ...
                this.columnuserEmail.MaxLength = 1;
                this.columnuserPassword.AllowDBNull = false;
                this.columnuserPassword.MaxLength = 1;
                this.columnuserFirstName.AllowDBNull = false;
                this.columnuserFirstName.MaxLength = 1;
                this.columnuserLastName.AllowDBNull = false;
                this.columnuserLastName.MaxLength = 1;
        ...
        public partial class userInfoRow : global::System.Data.DataRow {
            ...
            public int userPhoneNo {
                get {
                    return ((int)(this[this.tableuserInfo.userPhoneNoColumn]));
                }
                set {
                    this[this.tableuserInfo.userPhoneNoColumn] = value;
                }
            }
        }
...
namespace Onboarding_Project_2.Database2DataSetTableAdapters {
    ...
    public partial class userInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[userInfo] WHERE (([id] = @Original_id) AND ([userEmail] = @Original_userEmail) AND ([userPassword] = @Original_userPassword) AND ([userFirstName] = @Original_userFirstName) AND ([userLastName] = @Original_userLastName) AND ([userPhoneNo] = @Original_userPhoneNo))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_userPhoneNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "userPhoneNo", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[userInfo] ([id], [userEmail], [userPassword], [userFirstName], [userLastName], [userPhoneNo]) VALUES (@id, @userEmail, @userPassword, @userFirstName, @userLastName, @userPhoneNo);
SELECT id, userEmail, userPassword, userFirstName, userLastName, userPhoneNo FROM userInfo WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[userInfo] SET [id] = @id, [userEmail] = @userEmail, [userPassword] = @userPassword, [userFirstName] = @userFirstName, [userLastName] = @userLastName, [userPhoneNo] = @userPhoneNo WHERE (([id] = @Original_id) AND ([userEmail] = @Original_userEmail) AND ([userPassword] = @Original_userPassword) AND ([userFirstName] = @Original_userFirstName) AND ([userLastName] = @Original_userLastName) AND ([userPhoneNo] = @Original_userPhoneNo));
SELECT id, userEmail, userPassword, userFirstName, userLastName, userPhoneNo FROM userInfo WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@userPhoneNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "userPhoneNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_userPhoneNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "userPhoneNo", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Onboarding_Project_2.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, userEmail, userPassword, userFirstName, userLastName, userPhoneNo FROM" +
                " dbo.userInfo";
        ...
        public virtual int Fill(Database2DataSet.userInfoDataTable dataTable) {
        ...
        public virtual Database2DataSet.userInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet.userInfoDataTable dataTable = new Database2DataSet.userInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet.userInfoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_userEmail, string Original_userPassword, string Original_userFirstName, string Original_userLastName, int Original_userPhoneNo) {
            ...
            if ((Original_userFirstName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_userFirstName));
            }
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_userPhoneNo));
        ...
        public virtual int Insert(int id, string userEmail, string userPassword, string userFirstName, string userLastName, int userPhoneNo) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(userPhoneNo));
        ...
        public virtual int Update(int id, string userEmail, string userPassword, string userFirstName, string userLastName, int userPhoneNo, int Original_id, string Original_userEmail, string Original_userPassword, string Original_userFirstName, string Original_userLastName, int Original_userPhoneNo) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(userPhoneNo));
            ...
            if ((Original_userFirstName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_userFirstName));
            }
            if ((Original_userLastName == null)) {
                throw new global::System.ArgumentNullException("Original_userLastName");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_userPhoneNo));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userEmail, string userPassword, string userFirstName, string userLastName, int userPhoneNo, int Original_id, string Original_userEmail, string Original_userPassword, string Original_userFirstName, string Original_userLastName, int Original_userPhoneNo) {
            return this.Update(Original_id, userEmail, userPassword, userFirstName, userLastName, userPhoneNo, Original_id, Original_userEmail, Original_userPassword, Original_userFirstName, Original_userLastName, Original_userPhoneNo);
        }
    }
